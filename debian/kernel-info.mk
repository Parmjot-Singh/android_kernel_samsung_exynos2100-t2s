...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/exynos/exynos2100.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
#KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/exynos/i-forgot-the-name.dtbo
...
KERNEL_BOOTIMAGE_INITRAMFS_OFFSET = 0x84000000
KERNEL_BOOTIMAGE_SECONDIMAGE_OFFSET = 0x00000000
KERNEL_BOOTIMAGE_TAGS_OFFSET = 0x80000000

# Specify boot image security patch level if needed
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2023-11

# Required for header version 2, ignore otherwise
KERNEL_BOOTIMAGE_DTB_OFFSET = 0x81f00000
